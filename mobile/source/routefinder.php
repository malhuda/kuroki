...
<a href="#" class="list-group-item">
    ...
    <button type="button" onclick="location.href = '/dashboard/source/walkthrough/<?php echo $row['developer']; ?>/<?php echo $row['name']; ?>'" class="btn btn-warning">Lihat route</button>
    </span>
    </a>
